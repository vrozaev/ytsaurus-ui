...
## [1.75.0](https://github.com/vrozaev/ytsaurus-ui/compare/ui-v1.74.0...ui-v1.75.0) (2024-12-12)


### Features

* **ACL:** add inheritedFrom field [YTFRONT-3836] ([4bd121d](https://github.com/vrozaev/ytsaurus-ui/commit/4bd121d7b61907997d0e525e73d0312a43d01a50))
* **ACL:** inherited roles should be displayed separately [YTFRONT-3836] ([7edb2c4](https://github.com/vrozaev/ytsaurus-ui/commit/7edb2c42293088b865c6205fa3085929f082d10f))
* **ACL:** separate dialog for 'Edit inheritance' [YTFRONT-3836] ([83d5965](https://github.com/vrozaev/ytsaurus-ui/commit/83d5965d2e3cff0d77c38765604c669f2d9a6f63))
* **ACL:** use `[@idm](https://github.com/idm)_roles` for ACO (+tvm name) [YTFRONT-3836] ([03f139e](https://github.com/vrozaev/ytsaurus-ui/commit/03f139ed5c38c2e211bafddab8b5bb4e3805c918))
* add footer factory method [YTFRONT-4173] ([616ff0b](https://github.com/vrozaev/ytsaurus-ui/commit/616ff0b2d8786df0eb1d05f7f45169984cb20162))
* add UIFactory.getNavigationExtraTabs() method ([bddf57c](https://github.com/vrozaev/ytsaurus-ui/commit/bddf57cf45c52a0ab1002df5827ef49698c7644f))
* added ability to override default text on login page [[#636](https://github.com/vrozaev/ytsaurus-ui/issues/636)] ([28a47ec](https://github.com/vrozaev/ytsaurus-ui/commit/28a47ec5ccf66d085e886391ab6fa3ff15b7372d))
* **Bundles/Bundle:** add 'TabletErrors' tab for bundle page [YTFRONT-4119] ([7ec446a](https://github.com/vrozaev/ytsaurus-ui/commit/7ec446a64561c842cb7911b9318d9b1b7b16f270))
* **CellPreviewModal:** add support image preview [[#773](https://github.com/vrozaev/ytsaurus-ui/issues/773)] ([7b266dc](https://github.com/vrozaev/ytsaurus-ui/commit/7b266dc2f15d2a80dff861121244e927c4b2664a))
* **CellPreviewModal:** add support string preview [[#765](https://github.com/vrozaev/ytsaurus-ui/issues/765)] ([e779d16](https://github.com/vrozaev/ytsaurus-ui/commit/e779d161b928bc372be57cfaae199311c99dae1d))
* **Components/Nodes:** add gpu progress [YTFRONT-4306] ([7ec1f62](https://github.com/vrozaev/ytsaurus-ui/commit/7ec1f62eb996fdf10cc0d78a375ed07fd33f9a35))
* **Components/Nodes:** use better sorting for progress columns [YTFRONT-3801] ([3502577](https://github.com/vrozaev/ytsaurus-ui/commit/3502577afb59ee36a05d975e0e69b8647ece9d5d))
* **Components:** alert for offline node [YTFRONT-4153] ([e95801e](https://github.com/vrozaev/ytsaurus-ui/commit/e95801ee4abef7b6e47d8a6f5c96e6b8dcd87cbb))
* **Components:** show tags without filter [YTFRONT-4315] ([723e772](https://github.com/vrozaev/ytsaurus-ui/commit/723e77216750e3608b284b7953d43cbdee65c0d3))
* date32 datetime64 timestamp64 interval64 [YTFRONT-4087] ([6f2c8e5](https://github.com/vrozaev/ytsaurus-ui/commit/6f2c8e51c23f0099d1715cf21156fd36f43a34e4))
* **DownloadManager/Excel:** add 'Number precision mode' option [YTFRONT-4150] ([5a3a641](https://github.com/vrozaev/ytsaurus-ui/commit/5a3a641a0427700df566d5b35f3a1c2581c9ff50))
* **Groups:** now we can create new group via UI [[#634](https://github.com/vrozaev/ytsaurus-ui/issues/634)] ([99766cf](https://github.com/vrozaev/ytsaurus-ui/commit/99766cf33bae8153e1c238899513664c0fb6f12c))
* introduce poc of adhoc visualization on query results [[#641](https://github.com/vrozaev/ytsaurus-ui/issues/641)] ([6dd9896](https://github.com/vrozaev/ytsaurus-ui/commit/6dd98968ce15cf9667619f0c710d6a3dec8c21dc))
...
* **Job:** add 'Job trace' meta-table item [YTFRONT-4182] ([00c0691](https://github.com/vrozaev/ytsaurus-ui/commit/00c06919c5a31ea45068c9dbfe3f3ce5e0bbef3b))
* **logout:** make oauth logout optional [[#488](https://github.com/vrozaev/ytsaurus-ui/issues/488)] ([1b5591a](https://github.com/vrozaev/ytsaurus-ui/commit/1b5591a6d0a7dda2654a23cc65e439dd0e7e857b))
* **ManageTokens:** added a copy button for the token hash ([20190ef](https://github.com/vrozaev/ytsaurus-ui/commit/20190efde1f25b4c6f41373937459a04b992e293))
* **Markdown:** use @diplodoc/transform  [YTFRONT-4108] ([3b33bc9](https://github.com/vrozaev/ytsaurus-ui/commit/3b33bc9ef85069159b53aa12e7ca4c0eb09bf8b9))
* **Navigation/CellPreview:** add dynamic table cell preview [[#776](https://github.com/vrozaev/ytsaurus-ui/issues/776)] ([4fbbb06](https://github.com/vrozaev/ytsaurus-ui/commit/4fbbb06dcc428e1191f89d33367f15877539a7c2))
* **Navigation/CreateTableModal:** add 'Optimize for' option [YTFRONT-4139] ([be84c6a](https://github.com/vrozaev/ytsaurus-ui/commit/be84c6a288647b02775e9cbc288b865ffc11538b))
* **Navigation/DynTable:** fetch tablet errors from tabletErrosApi [YTFRONT-4119] ([b082a3d](https://github.com/vrozaev/ytsaurus-ui/commit/b082a3d830d0ef6da12b53ea271c64605738ccde))
* **Navigation/Flow:** add new tab [YTFRONT-3978] ([1ef39d7](https://github.com/vrozaev/ytsaurus-ui/commit/1ef39d7cee11e4e6a6f3eb4bfb044e95b4f6fc60))
* **Navigation/MapNode:** add UIFactory.getMapNodeExtraCreateActions(...) method ([ae6ae51](https://github.com/vrozaev/ytsaurus-ui/commit/ae6ae5187e29787d09a26144215736ade9b8d1f4))
* **Navigation/MapNode:** allow override node-icon through UIFactory.getNavigationMapNodeSettings ([c97a4a0](https://github.com/vrozaev/ytsaurus-ui/commit/c97a4a09bcd8cfc40f5e5eeec203ee1aab417948))
* **Navigation/Queue:** add alerts section [YTFRONT-4144] ([8b0157c](https://github.com/vrozaev/ytsaurus-ui/commit/8b0157c08dac8757a04a4129c83ea8de332f6861))
* **Navigation/Table:** add support truncated image preview [[#773](https://github.com/vrozaev/ytsaurus-ui/issues/773)] ([34daef1](https://github.com/vrozaev/ytsaurus-ui/commit/34daef10fef4c22d0f546b2ec6350c0008135212))
* **Navigation:** open access logs in qt [YTFRONT-4345] ([97a42b8](https://github.com/vrozaev/ytsaurus-ui/commit/97a42b87d55c78e92224f43c28bac4d9fd8932ca))
* now we can disable filter optimization on the operations page via cluster config [[#700](https://github.com/vrozaev/ytsaurus-ui/issues/700)] ([771294a](https://github.com/vrozaev/ytsaurus-ui/commit/771294ab5bb33b2b11413da2c52ec8e85d175f3d))
* **Operation/Jobs:** add 'with_monitoring_descriptor' filter [YTFRONT-4078] ([aa575c9](https://github.com/vrozaev/ytsaurus-ui/commit/aa575c9e3427c92f6f935fd5b25ef88887f2a911))
* **OperationJobsTable:** add TaskName column in table [[#828](https://github.com/vrozaev/ytsaurus-ui/issues/828)] ([90c8586](https://github.com/vrozaev/ytsaurus-ui/commit/90c8586df5bbb50ec08da012e0eab1b37dd64b36))
* **PoolTreeSuggestControl:** now we could select multiply pool trees on clique creation/edit [[#841](https://github.com/vrozaev/ytsaurus-ui/issues/841)] ([89c79a8](https://github.com/vrozaev/ytsaurus-ui/commit/89c79a8733128c8ce0214bbe0857b583bce1d449))
* prepare code to work with additional entries [YTFRONT-4122] ([66e4933](https://github.com/vrozaev/ytsaurus-ui/commit/66e4933a2147a67d7a92e9300540484526092411))
* **Queries:** alias and column autocomplete [YTFRONT-4486] ([b47d3fb](https://github.com/vrozaev/ytsaurus-ui/commit/b47d3fb1fc215777c0b594dd7e7643c897e830ba))
* **Queries:** allow users to copy query id ([f6acc89](https://github.com/vrozaev/ytsaurus-ui/commit/f6acc897caed62d6a160e657d2e605d8b0182d5a))
* **Queries:** change engine order [YTFRONT-4498] ([9a8dce8](https://github.com/vrozaev/ytsaurus-ui/commit/9a8dce8470268a076756c3d8692dd7f5e66ba7d6))
* **Queries:** change path auto suggest weight [YTFRONT-4479] ([9504939](https://github.com/vrozaev/ytsaurus-ui/commit/95049392606b78cae579dc9e13734cb5b65f46fd))
* **Queries:** change query result tabs order [YTFRONT-4381] ([d851ddf](https://github.com/vrozaev/ytsaurus-ui/commit/d851ddfac14f6de1e55ee3c4192fcff6ddb92388))
* **Queries:** default ACO [[#436](https://github.com/vrozaev/ytsaurus-ui/issues/436)] ([0eba698](https://github.com/vrozaev/ytsaurus-ui/commit/0eba6989e45b147a7ddd0ab0bfc753a2c3a68e2b))
* **Queries:** info nodes in query error [YTFRONT-4342] ([c2f4f3f](https://github.com/vrozaev/ytsaurus-ui/commit/c2f4f3febff66c4330e3db4b919e7896a244b55f))
* **Queries:** monaco line number in url [YTFRONT-4505] ([2433ed6](https://github.com/vrozaev/ytsaurus-ui/commit/2433ed6235a9f61833df32c70b0f0b3d711db29c))
* **Query:** changing the default name for new tables [YTFRONT-4249] ([cc19d6b](https://github.com/vrozaev/ytsaurus-ui/commit/cc19d6bc71607751a5d019dfc6ce8fa1261a6e1c))
* **Query:** custom vcs [YTFRONT-4257] ([3e0df9b](https://github.com/vrozaev/ytsaurus-ui/commit/3e0df9b3b64bb515d748118f8a60d4f88f3274a2))
* **Query:** multiple aco with backward compatible [YTFRONT-4238] ([7efe878](https://github.com/vrozaev/ytsaurus-ui/commit/7efe87881d5fd69d8a86252c0d401f8c950bb7a2))
* **Query:** new navigation tab [YTFRONT-4235] ([428a72c](https://github.com/vrozaev/ytsaurus-ui/commit/428a72c7163bc353a5524445e956d4ca1ff50e9e))
* **Query:** new query aco format [YTFRONT-4238] ([a3ba06a](https://github.com/vrozaev/ytsaurus-ui/commit/a3ba06a2317b1f54fdd23f52d7bf5795dabc4643))
* **Query:** path autocomplete [YTFRONT-4264] ([ab9ba1f](https://github.com/vrozaev/ytsaurus-ui/commit/ab9ba1f4497c70649a8e92df9666c2cf2ff9ed24))
* **Query:** share button new design [YTFRONT-4286] ([7d66e6c](https://github.com/vrozaev/ytsaurus-ui/commit/7d66e6c56bc9f9489bb0ee89a2de3791dfd22103))
* **Query:** share query button [YTFRONT-4239] ([67e84bc](https://github.com/vrozaev/ytsaurus-ui/commit/67e84bc383ebce81a57928d44d384a5ed7ab0d99))
* **Query:** spyt clicue selector [YTFRONT-4219] ([6288c73](https://github.com/vrozaev/ytsaurus-ui/commit/6288c73e4a1919312aae55040ce2baab331e1875))
* **Query:** title with query data [YTFRONT-4186] ([5282fb7](https://github.com/vrozaev/ytsaurus-ui/commit/5282fb77dc5038bff78d55d25f146882c04adfda))
* **QueryTracker/Table:** add support truncated image preview [[#773](https://github.com/vrozaev/ytsaurus-ui/issues/773)] ([39684bc](https://github.com/vrozaev/ytsaurus-ui/commit/39684bc7d68ebb914d8bdddf27fa9f08da491242))
* **queryTracker:** add search field to statistics tab in query tracker [[#301](https://github.com/vrozaev/ytsaurus-ui/issues/301)] ([551e66a](https://github.com/vrozaev/ytsaurus-ui/commit/551e66aaa127c0db31abefa92b41782a598a4899))
* **Query:** vcs navigation [YTFRONT-4147] ([58be722](https://github.com/vrozaev/ytsaurus-ui/commit/58be72232945ef8bcbf17327e3041a5c263256af))
* **Scheduling:** changed validation for name [YTFRONT-4319] ([7bd7852](https://github.com/vrozaev/ytsaurus-ui/commit/7bd7852ab57bd084b6fe9f24086272a4fd3b7aa9))
* **Scheduling:** hide all alerts [YTFRONT-4322] ([63d60fa](https://github.com/vrozaev/ytsaurus-ui/commit/63d60faeb702c451029ee987caf66120d1181255))
* **Settings:** change default pinned pages [YTFRONT-4364] ([bb51fa0](https://github.com/vrozaev/ytsaurus-ui/commit/bb51fa050c1bac99408c1a10166dae758ec8aa16))
* **System/Nodes:** allow to expand groups of nodes [YTFRONT-3297] ([7c8330e](https://github.com/vrozaev/ytsaurus-ui/commit/7c8330e49ead3b01ae7bd962a9887e05940ec10d))
* **System:** headers of sections should be sticky [YTFRONT-4420] ([7e04dae](https://github.com/vrozaev/ytsaurus-ui/commit/7e04dae01262c2b4cf0c977acd269ef6593ae1e6))
* **System:** introduce new switch leader button ([43f5034](https://github.com/vrozaev/ytsaurus-ui/commit/43f5034405fcf58bd045406551a97f52e7a4a3ed))
* **System:** maintenance button [YTFRONT-4217] ([3c5d0d2](https://github.com/vrozaev/ytsaurus-ui/commit/3c5d0d225d244204b87fde6dc182489130ad20e6))
* **System:** new cluster colors [YTFRONT-4409] ([f7cb2c0](https://github.com/vrozaev/ytsaurus-ui/commit/f7cb2c06fa65bd6bf59f7a45cd8ef8bc7cdba8d7))
...
* **Table/Excel:** now we can setup uploadTableExcelBaseUrl and exportTableBaseUrl per cluster [[#717](https://github.com/vrozaev/ytsaurus-ui/issues/717)] ([88dec84](https://github.com/vrozaev/ytsaurus-ui/commit/88dec846b765b5e4f9413de245aad6ca956819b9))
* **Table:** add "view" button for truncated cells [[#655](https://github.com/vrozaev/ytsaurus-ui/issues/655)] ([c688f1f](https://github.com/vrozaev/ytsaurus-ui/commit/c688f1f6e4b674c1cb79bafc523ded16948e0516))
* **tokens:** allow user to issue and manage tokens from ui [[#241](https://github.com/vrozaev/ytsaurus-ui/issues/241)] ([6bdd6d2](https://github.com/vrozaev/ytsaurus-ui/commit/6bdd6d2d6ae767a90a2c72f629325b0d6c56db3a))
* udpate @gravity-ui/charkit, @gravity-ui/yagr [YTFRONT-4305] ([a65be74](https://github.com/vrozaev/ytsaurus-ui/commit/a65be74a5d9017a5c0d8159f80982891e3afc8cc))
* **UIFactory:** extract defaultUIFactory to separate file [YTFRONT-3814] ([dfc8930](https://github.com/vrozaev/ytsaurus-ui/commit/dfc8930d7925f4a6389cd6600f1ce165f2fb2852))
* **UIFactory:** introduce renderCustomPreloaderError method which allows to render custom error page ([b580749](https://github.com/vrozaev/ytsaurus-ui/commit/b580749cb803e0bacb830b3a0fd33b9fbe2b9646))
* **uikit6:** update dependencies [[#502](https://github.com/vrozaev/ytsaurus-ui/issues/502)] ([5a92c5f](https://github.com/vrozaev/ytsaurus-ui/commit/5a92c5fbbfccf43a788946b3ab9e95ebca0e74bf))
* **Users:** introduce "Change password" tab in UsersPageEditor, now we can change user passwords via UI [[#633](https://github.com/vrozaev/ytsaurus-ui/issues/633)] ([2a06c23](https://github.com/vrozaev/ytsaurus-ui/commit/2a06c237ce10a94d7970a2b09462fdc31aa9a352))
* **Users:** introduce "create new" button which allows to create new user [[#633](https://github.com/vrozaev/ytsaurus-ui/issues/633)] ([543dcf0](https://github.com/vrozaev/ytsaurus-ui/commit/543dcf04764d9158cdc222fcccac71f1a3840836))
* **Users:** introduce "Name" field in UsersPageEditor dialog, now we can rename users via UI [[#633](https://github.com/vrozaev/ytsaurus-ui/issues/633)] ([bcfaead](https://github.com/vrozaev/ytsaurus-ui/commit/bcfaead8bb9f2e65ed78f0da3099130b3930626f))
* **Users:** introduce remove button which allows to remove user [[#633](https://github.com/vrozaev/ytsaurus-ui/issues/633)] ([461f6d9](https://github.com/vrozaev/ytsaurus-ui/commit/461f6d9ee5dce37d49b4e5452e1739e6b7630001))
* **VCS:** new list sort order [YTFRONT-4520] ([cb6b000](https://github.com/vrozaev/ytsaurus-ui/commit/cb6b0008fecf69dd052dcde2ec249539ccb40a78))
* **YQLTable:** add "view" button for truncated cells [[#702](https://github.com/vrozaev/ytsaurus-ui/issues/702)] ([ee776c1](https://github.com/vrozaev/ytsaurus-ui/commit/ee776c1158eaaf21a53ae6226dbd5ba83427c646))


### Bug Fixes

* **AccountsGeneralTab:** do not show TabletAccountingNotice if enable_per_account_tablet_accounting is enabled ([7de2eb5](https://github.com/vrozaev/ytsaurus-ui/commit/7de2eb5f25e9216b9dd03e3bf2d8131397cd77e9))
* **ACL:** better names for buttons [YTFRONT-3836] ([a45be15](https://github.com/vrozaev/ytsaurus-ui/commit/a45be15d96f4c2c287cda7e28cfb9ab04eac0aa9))
* **ACL:** inheritAcl/inheritResponsible should be properly checked [YTFRONT-4492] ([dca379f](https://github.com/vrozaev/ytsaurus-ui/commit/dca379f66f892e74ea8a291aa8074e38449cbba7))
* **ACL:** minor fix for meta-block [YTFRONT-3836] ([a3859d0](https://github.com/vrozaev/ytsaurus-ui/commit/a3859d059efff237bbd7f58b25b67f40bca8b99e))
* **ACL:** permissions should be sorted [YTFRONT-4432] ([881c08c](https://github.com/vrozaev/ytsaurus-ui/commit/881c08c2c2883c6d0288682c12fbbf3e3dafd4d6))
* **AclUpdateMessage:** minor fix for layout ([ed85d7f](https://github.com/vrozaev/ytsaurus-ui/commit/ed85d7fab663ddc1a75c614aabb6a062a635b329))
* added support for dark and light themes by override yfm styles [[#712](https://github.com/vrozaev/ytsaurus-ui/issues/712)] ([b7cce12](https://github.com/vrozaev/ytsaurus-ui/commit/b7cce12fcbf2612d69b528932fc39b160f8bb464))
* **axios/withXSRFToken:** additional to b7738a97c3177df02a3a9112112ac97e4afef118 ([88b5efa](https://github.com/vrozaev/ytsaurus-ui/commit/88b5efafd5d4ec480ea50f75e15314974786f427))
* **axios:** use withXSRFToken ([b7738a9](https://github.com/vrozaev/ytsaurus-ui/commit/b7738a97c3177df02a3a9112112ac97e4afef118))
* **Breadcrumbs:** breadcrumb popup links not working [YTFRONT-4121] ([bad5795](https://github.com/vrozaev/ytsaurus-ui/commit/bad579593e391bfb73ec0f45e2b99c8e26659063))
* bring back 'npm run build:lib' ([417b21e](https://github.com/vrozaev/ytsaurus-ui/commit/417b21ea08564e68c07f9081e90dc2cfdb3d504c))
* bring back assets to package @ytsaurus/ui ([a86e2d0](https://github.com/vrozaev/ytsaurus-ui/commit/a86e2d06880417b5c19c1859c8f6598f1c611291))
* **Bundles:** get list limits [YTFRONT-4177] ([f9dc386](https://github.com/vrozaev/ytsaurus-ui/commit/f9dc386d3dda10007c42a0b725c32614ba3eb2bc))
* **Bundles:** memory limit [YTFRONT-4170] ([26491e0](https://github.com/vrozaev/ytsaurus-ui/commit/26491e0096c0c95371a88ea0d7d13cf14cf65018))
* **Bundles:** memory limit [YTFRONT-4170] ([4be139c](https://github.com/vrozaev/ytsaurus-ui/commit/4be139c64a7538e038443cdd8100150c1b8a00f8))
* **Bundles:** sort by node [YTFRONT-4131] ([64b59b1](https://github.com/vrozaev/ytsaurus-ui/commit/64b59b12a58161141c3a599f65350dc2fe748501))
* **CellPreviewModal:** fix control to be sticky when scroll [[#703](https://github.com/vrozaev/ytsaurus-ui/issues/703)] ([c5e91cb](https://github.com/vrozaev/ytsaurus-ui/commit/c5e91cbee5d122c32784145dbc2d49e76a5ab434))
* **CellPreviewModal:** fix opening preview for table with offset [[#778](https://github.com/vrozaev/ytsaurus-ui/issues/778)] ([7347349](https://github.com/vrozaev/ytsaurus-ui/commit/7347349c9adaedb1a8d7ea4a933a8316f2b296d2))
* **ClusterPage:** align "Loading &lt;cluster name&gt;..." text to center of the page ([f367d5b](https://github.com/vrozaev/ytsaurus-ui/commit/f367d5b3bc5b7b612b611a7aa0b70f00f909ebf5))
* **Clusters:** change body flex grow [YTFRONT-4221] ([097da73](https://github.com/vrozaev/ytsaurus-ui/commit/097da73a10fb8ab2f1392313148cb74b2ba00867))
* **ClustersMenu:** the page should not be broken with '[' filter [YTFRONT-4272] ([7eb5c7c](https://github.com/vrozaev/ytsaurus-ui/commit/7eb5c7cfedc28935034041a82ef989ff44e4c460))
* **ColumnHeader/SortIcon:** add tooltip for sort direction (+allowUnordered) [YTFRONT-3801] ([911e457](https://github.com/vrozaev/ytsaurus-ui/commit/911e45748fc818c50a962ef65b74c2b62b92ed96))
* **Componens/Nodes/Node:** fix for width of memory popup [[#502](https://github.com/vrozaev/ytsaurus-ui/issues/502)] ([fc9c882](https://github.com/vrozaev/ytsaurus-ui/commit/fc9c882e1177cce8f5f007c6a8a0d187724ffb1d))
* **Components/Nodes:** fix alerts filter [YTFRONT-4301] ([861f57c](https://github.com/vrozaev/ytsaurus-ui/commit/861f57c5c213c0c22e6df8f46f16e2d0c3d2a188))
* **Components/Nodes:** fix filtering by racks ([b58e8ba](https://github.com/vrozaev/ytsaurus-ui/commit/b58e8ba8de094e635d2d697589d68e2418b5660b))
* **Components/Nodes:** fixes for add_maintenance/remove_maintenance [YTFRONT-4480] ([85ef77d](https://github.com/vrozaev/ytsaurus-ui/commit/85ef77dfbb540a0c253e754c2cefaa0db884a191))
* **Components/Nodes:** get rid of duplicates of nodes [YTFRONT-4268] ([131c857](https://github.com/vrozaev/ytsaurus-ui/commit/131c8574b6cc1e076bb8076437ea542a7c149415))
* **Components/Node:** show decimal cpus [[#675](https://github.com/vrozaev/ytsaurus-ui/issues/675)] ([b42b0bb](https://github.com/vrozaev/ytsaurus-ui/commit/b42b0bb147cc13abe05715e6a0fb453724d2ec50))
* **Components:** use search of substring for 'Filter hosts' ([ac2c477](https://github.com/vrozaev/ytsaurus-ui/commit/ac2c477abb47c86ba098264c8e7132b40e547422))
* **Components:** wrong tablet memory column name [YTFRONT-4408] ([21cc198](https://github.com/vrozaev/ytsaurus-ui/commit/21cc198c475c62f2ee6041fc9a1b2c3057a39155))
* **Docs:** fix incorrect documentation urls ([9c4a8db](https://github.com/vrozaev/ytsaurus-ui/commit/9c4a8db47461f14881d128b7887630331cbfbd6f))
* **DownloadManager:** fix for ranges [YTFRONT-4215] ([0f117ca](https://github.com/vrozaev/ytsaurus-ui/commit/0f117ca913abd8a57d252b40904d1b050bd5c39e))
* **DownloadManager:** minor css fix [YTFRONT-4215] ([35ef8c6](https://github.com/vrozaev/ytsaurus-ui/commit/35ef8c6a8bbd41cb8bbfa31c92231450a84e8c9b))
* **e2e:** navigation base ([2e6d633](https://github.com/vrozaev/ytsaurus-ui/commit/2e6d63340c1676a368cd89b3185b8bbc1f2da381))
* fix for release ([e8019bc](https://github.com/vrozaev/ytsaurus-ui/commit/e8019bc26ec8a22a81eb2b5aef2683d9a39d3994))
* fix for release ([def6dad](https://github.com/vrozaev/ytsaurus-ui/commit/def6dad1de2d3da88c728aed8695db801b25b8db))
* fix logging of axios error in sendAndLogError function ([b9239dc](https://github.com/vrozaev/ytsaurus-ui/commit/b9239dc43feab214b4e3520b21e662755be4f33a))
* footer problem in cluster page [YTFRONT-4173] ([8800bbc](https://github.com/vrozaev/ytsaurus-ui/commit/8800bbc205ffe2bc0211fb4c1ac081967287c695))
* **Groups:** expand group tree on non-empty group filter [[#853](https://github.com/vrozaev/ytsaurus-ui/issues/853)] ([1255e14](https://github.com/vrozaev/ytsaurus-ui/commit/1255e1401e68199eda89c8106061eaec8a067061))
* **MaintenancePage:** rework maintenance activation ([c7ed6e4](https://github.com/vrozaev/ytsaurus-ui/commit/c7ed6e4702add1a9e62dae2e278104f3be01c007))
* **manage-tokes:** show null in the token list if tokenPrefix is unknown [[#626](https://github.com/vrozaev/ytsaurus-ui/issues/626)] ([135c92e](https://github.com/vrozaev/ytsaurus-ui/commit/135c92e4e31b7776b0e5ce6604e0d143522012ff))
* **ManageTokens:** fixed freeze of the password  window ([c2e20ab](https://github.com/vrozaev/ytsaurus-ui/commit/c2e20ab1623d2781a45d0fa4b93781d972cebaf4))
* **ManageTokens:** horizontal scroll in the table is off ([65e0b6a](https://github.com/vrozaev/ytsaurus-ui/commit/65e0b6acf270d42a46680e9ea5e4b110eccb8b2c))
* minor fix ([e678639](https://github.com/vrozaev/ytsaurus-ui/commit/e678639cf25668743326ede2ec11e95907bc6f85))
* minor fix for build ([7c804d9](https://github.com/vrozaev/ytsaurus-ui/commit/7c804d914293a1cef947390af17b6e5d8a800a99))
* minor fix for README.md ([aa5ec83](https://github.com/vrozaev/ytsaurus-ui/commit/aa5ec83230247430731924ec913538e919277026))
* names of cookies with a colon [[#587](https://github.com/vrozaev/ytsaurus-ui/issues/587)] ([79a4254](https://github.com/vrozaev/ytsaurus-ui/commit/79a42545c1a2684fb10aaa20e754c9fa60a9ae14))
* **Navigation/Consumer,Navigation/Queue:** show errors [YTFRONT-4144] ([914a6a0](https://github.com/vrozaev/ytsaurus-ui/commit/914a6a066ce30928673749bd8e2250c51a3e637b))
* **Navigation/DeleteModal:** make header of deleting items list and  "permanently delete" checkbox is sticky [YTFRONT-4245] ([3da8d44](https://github.com/vrozaev/ytsaurus-ui/commit/3da8d4436b3f1fc93e7d764e5e67bfb8dc2524fc))
* **Navigation/Favourites:** allow to add items when the value is undefined ([69c9202](https://github.com/vrozaev/ytsaurus-ui/commit/69c920222ce1f3a0381efc70aa65da190f04b0e0))
* **Navigation/File:** allow remote-copy for 'file' node type [YTFRONT-4296] ([aff83de](https://github.com/vrozaev/ytsaurus-ui/commit/aff83def8abee98eb1937b9495f828d553fd4d16))
* **Navigation/MapNode:** allow to select rows by click on first cell [YTFRONT-4391] ([85e915c](https://github.com/vrozaev/ytsaurus-ui/commit/85e915cf2c72f4137e9b73b87b7c1748db5b5094))
* **Navigation/MapNode:** minor fix for css [YTFRONT-4291] ([e5932f8](https://github.com/vrozaev/ytsaurus-ui/commit/e5932f817c8ceacdca713ad532814d0b8f7b3f39))
* **Navigation/MapNode:** use 'navmode=auto' when node is clicked ([3d473c4](https://github.com/vrozaev/ytsaurus-ui/commit/3d473c426daea116c610860e7c15141f963e381f))
* **Navigation/Queue:** allow Queue tab for replication_table/chaos_replicated_table [YTFRONT-4144] ([228db6a](https://github.com/vrozaev/ytsaurus-ui/commit/228db6a3a4c9a57db0d36812d8fd2e412be0c901))
* **Navigation/RemoteCopy:** fix for disabled 'Confirm' button [YTFRONT-4296] ([a6b7bde](https://github.com/vrozaev/ytsaurus-ui/commit/a6b7bdebb3db6639174761fe4551066276baaed0))
* **Navigation/ReplicatedTable:** add info icon for 'Automatic mode switch' [YTFRONT-4327] ([5446fc3](https://github.com/vrozaev/ytsaurus-ui/commit/5446fc381fd17695cdbd22b280c53d0deb5e8a86))
* **Navigation/ReplicatedTable:** attribute /[@tablet](https://github.com/tablet)_error_count should affect tablet errors count [YTFRONT-4447] ([5860748](https://github.com/vrozaev/ytsaurus-ui/commit/58607481c9e642774d26b285b02c8f8092982be3))
* **Navigation/ReplicatedTable:** rename column [YTFRONT-4327] ([79f664b](https://github.com/vrozaev/ytsaurus-ui/commit/79f664b663de172c8711e3aa255c4b73729514d1))
* **Navigation/Table:** draggable row selector should work properly [YTFRONT-4396] ([d702adb](https://github.com/vrozaev/ytsaurus-ui/commit/d702adb6b2e50f81a4d60cd67f77308b454ee14e))
* **Navigation/Table:** use POST-requests to read tables [YTFRONT-4259] ([7281e79](https://github.com/vrozaev/ytsaurus-ui/commit/7281e79d41f3db5dabe056378b7c276412a4ed5a))
* **Navigation/TopRow/PathEditor:** select text when editor is focused [YTFRONT-4387] ([fd4beb6](https://github.com/vrozaev/ytsaurus-ui/commit/fd4beb695e05e35d7648ee0ee430ce759f90a825))
* **Navigation:** additional to a62d64acbc23a7eff7d4cfb4406fea6b6a1a3887 [YTFRONT-4511] ([b17545f](https://github.com/vrozaev/ytsaurus-ui/commit/b17545f2735efac23f1f80bac42e777f2d9e6209))
* **Navigation:** allow 'Tablet errors' for nodes with `/[@tablet](https://github.com/tablet)_error_count &gt;= 0` [YTFRONT-3951] ([637def7](https://github.com/vrozaev/ytsaurus-ui/commit/637def78c2c448e0dfd4ce363222a8ba7fbef5a4))
* **Navigation:** bring back 'Request permissions' button [YTFRONT-4511] ([a62d64a](https://github.com/vrozaev/ytsaurus-ui/commit/a62d64acbc23a7eff7d4cfb4406fea6b6a1a3887))
* **Navigation:** change request permission button [YTFRONT-4379] ([9eefa05](https://github.com/vrozaev/ytsaurus-ui/commit/9eefa050f002a9a4dd829b32c4cf75bf4de068cb))
* **Navigation:** correct cluster name in yql query [YTFRONT-4274] ([4b9cab5](https://github.com/vrozaev/ytsaurus-ui/commit/4b9cab511c4ba1b65d02df8923a44cea0beba3ee))
* **Navigation:** correct data format in errors [YTFRONT-4251] ([ed6096e](https://github.com/vrozaev/ytsaurus-ui/commit/ed6096e7f1ce337546a0271506db6f5b7f9798a6))
* **Navigation:** correct output of numbers in tablet errors [YTFRONT-4251] ([fe02b58](https://github.com/vrozaev/ytsaurus-ui/commit/fe02b5879e092fc1f4d674b7594b6eb8eb3d10fd))
* **Navigation:** do not reset contentMode on navigation [[#511](https://github.com/vrozaev/ytsaurus-ui/issues/511)] ([916ede3](https://github.com/vrozaev/ytsaurus-ui/commit/916ede342fac224d6c077704be929999ab326863))
* **Navigation:** error message in table [YTFRONT-4312] ([d3e94cd](https://github.com/vrozaev/ytsaurus-ui/commit/d3e94cd2893970a2982bf3943da0dfd181f649f8))
* **Navigation:** keyboard navigation [YTFRONT-4493] ([3b9fb24](https://github.com/vrozaev/ytsaurus-ui/commit/3b9fb24c2b3aae09177e10827e99213b45b9a978))
* **Navigation:** now breadcrumbs dropdown items are clickable [[#528](https://github.com/vrozaev/ytsaurus-ui/issues/528)] ([2df7319](https://github.com/vrozaev/ytsaurus-ui/commit/2df73197d827d0912ef8203f0357f1dfda681ecd))
* **Navigation:** pool tree select popup [YTFRONT-4380] ([f52eb90](https://github.com/vrozaev/ytsaurus-ui/commit/f52eb90da82306d6bf191a0d1375f3c30eaa3aac))
* **Navigation:** widget with footer problem [YTFRONT-4221] ([5b4bbe1](https://github.com/vrozaev/ytsaurus-ui/commit/5b4bbe152f8ba3701b895b0f8b0bf21726e1bf17))
* now non-standalone odin page recieve correct cluster ([b4739a4](https://github.com/vrozaev/ytsaurus-ui/commit/b4739a4503028aebcfefc0f8ae42fe3b29e26b50))
* now we can specify loginPageSettings per cluster ([be872cc](https://github.com/vrozaev/ytsaurus-ui/commit/be872ccd9a52d5ad3d04f694602713f1b971759b))
* **Odin:** use the same format for DatePicker in odin ([5a25c2f](https://github.com/vrozaev/ytsaurus-ui/commit/5a25c2f9aec338b39bf49a7e9a8836516d6a0980))
* **Operation/Details:** Minified React error [#31](https://github.com/vrozaev/ytsaurus-ui/issues/31) [YTFRONT-4417] ([6324642](https://github.com/vrozaev/ytsaurus-ui/commit/6324642bfd1474cb9c688637d61a90e3cbd5c42b))
* **Operation/Job/Statistics:** handle undefined [YTFRONT-4300] ([ca0da3c](https://github.com/vrozaev/ytsaurus-ui/commit/ca0da3c32e34403491a9c68fc78e769ac06989ce))
* **Operation/JobsMonitor:** tab should be displayed without delay [YTFRONT-4077] ([9673252](https://github.com/vrozaev/ytsaurus-ui/commit/96732524d0025dff154710c1b5b814da1d01865d))
* **Operation/Specification/Input:** fix for 'remote_copy' operations [YTFRONT-4265] ([502bd53](https://github.com/vrozaev/ytsaurus-ui/commit/502bd539edacac20c4f9e6caf7e4360488440cd1))
* **Operation/Specification/Input:** links should respect 'cluster' attribute [YTFRONT-4265] ([4fbece7](https://github.com/vrozaev/ytsaurus-ui/commit/4fbece7a7b6f228b31179af5fc2f4d74a180b221))
* **Operation/Specification/Input:** show cluster in links [YTFRONT-4265] ([bfb59cf](https://github.com/vrozaev/ytsaurus-ui/commit/bfb59cfebbb3dfd137094e98ebd06c39db7f44b0))
* **OperationPool:** minor fix for css ([9f9b32d](https://github.com/vrozaev/ytsaurus-ui/commit/9f9b32d74c09780b207c6db1c52f327ed3549be1))
* **Operations/Details/MetaTable:** blinking UI when hover on long pool name [YTFRONT-4308] ([395c849](https://github.com/vrozaev/ytsaurus-ui/commit/395c8496e6770c9da1263c9b9e6589bfd157e991))
* **Operations/Details/Specifiction:** do not display empty command [YTFRONT-4507] ([cadc5fc](https://github.com/vrozaev/ytsaurus-ui/commit/cadc5fc9472240a1cb526aa107f777c8774c6bad))
* **Operations/Operation/JobsMonitor:** use 'with_monitoring_descriptor' flag [YTFRONT-4346] ([bbf5415](https://github.com/vrozaev/ytsaurus-ui/commit/bbf54154a389895f64eb7e6c04dbdc15aee30e40))
* **Operations:** job tooltip value format [YTFRONT-4211] ([de238b1](https://github.com/vrozaev/ytsaurus-ui/commit/de238b19e4ce1ce66666c3c5dddb4e05693174b4))
* **OperationsList:** fix incorrect filters on OperationSuggestFilter blur [[#705](https://github.com/vrozaev/ytsaurus-ui/issues/705)] ([a738c5b](https://github.com/vrozaev/ytsaurus-ui/commit/a738c5b182a192cb0e5c847ab31e90675da1c144))
* **Operations:** save pool tree in url [YTFRONT-4355] ([ee2fe0e](https://github.com/vrozaev/ytsaurus-ui/commit/ee2fe0e5b7bc6e64c26cdc4290c7887fc554cedf))
* **package.json:** minor fix ([c5cfed3](https://github.com/vrozaev/ytsaurus-ui/commit/c5cfed362d7656bdc7979f2ed35dda329b377954))
* **packages/ui/package.json:** fix for repository.url ([23f2a54](https://github.com/vrozaev/ytsaurus-ui/commit/23f2a5405357fcabb1bdfa25bf340018cd9a112a))
* **PathViewer:** now path viewer run list command by default, because "get /" command might lead to perfomance issue [[#814](https://github.com/vrozaev/ytsaurus-ui/issues/814)] ([006d215](https://github.com/vrozaev/ytsaurus-ui/commit/006d21576975feb2d20d6919f88c62542ab4ff30))
* **Queries:** chyt spyt path autocomplete [YTFRONT-4368] ([df3cff1](https://github.com/vrozaev/ytsaurus-ui/commit/df3cff140ee9d7bee48c19be55cc66d00e06cdcd))
* **Queries:** queries page fixes [YTFRONT-4340] ([676354e](https://github.com/vrozaev/ytsaurus-ui/commit/676354e75f8b2d8457ceda002f2943b167cd0192))
* **Queries:** run query hotkeys [YTFRONT-4462] ([7d69305](https://github.com/vrozaev/ytsaurus-ui/commit/7d6930558cbdd214044e07b16f7f8a63c748efac))
* **Queries:** share button in safari [YTFRONT-4503] ([38842f4](https://github.com/vrozaev/ytsaurus-ui/commit/38842f49be3ea945a91dc2f463f8448c5f92173e))
* **query/custom-result-tab:** show tab when there is a query result ([bf64b2c](https://github.com/vrozaev/ytsaurus-ui/commit/bf64b2cf9aef5e5d6281799e45c831eb58f910f3))
* **Query:** do not show vcs if vcsSettings is empty ([7df0b04](https://github.com/vrozaev/ytsaurus-ui/commit/7df0b045ecba077363d03471b8d196301d6b8a65))
* **Query:** empty blocks in result [YTFRONT-4323] ([b39aa3e](https://github.com/vrozaev/ytsaurus-ui/commit/b39aa3e873f44dd45da2c7bf8005ccb93294a40e))
* **Query:** fix adhoc charts ([2c441c5](https://github.com/vrozaev/ytsaurus-ui/commit/2c441c5d79cc680000038d2bfc670e247e488e08))
* **Query:** query and progress tab [YTFRONT-4185] ([c74c0fc](https://github.com/vrozaev/ytsaurus-ui/commit/c74c0fced87cc839839d2128d4e8a910c813b0d2))
* **Query:** select in error line [YTFRONT-4208] ([85508dc](https://github.com/vrozaev/ytsaurus-ui/commit/85508dcdd79758f6e1c744b7d2805e7f25056cd7))
* **QueryTracker:** fix error when switching to another query with open statistics tab ([ef61008](https://github.com/vrozaev/ytsaurus-ui/commit/ef61008be538119dfc8754b20c06105dbf8058ff))
* **QueryTracker:** redirect to yt operations from running yql queries [[#522](https://github.com/vrozaev/ytsaurus-ui/issues/522)] ([2a91613](https://github.com/vrozaev/ytsaurus-ui/commit/2a916136fee38055f3e85ad1325829dd68e2fcd0))
* **QueryTracker:** support dark theme in statistic table ([b3f1d57](https://github.com/vrozaev/ytsaurus-ui/commit/b3f1d5766f880605c6aa975fc515a8cca568a933))
* **QueryTracker:** use treatValAsData option of unpika by default ([2009d96](https://github.com/vrozaev/ytsaurus-ui/commit/2009d96f9b822dbbd3e043628faa681731c4cd77))
* **Query:** utf decode in result table [[#533](https://github.com/vrozaev/ytsaurus-ui/issues/533)] ([7cadb62](https://github.com/vrozaev/ytsaurus-ui/commit/7cadb62ffb276edece14266393a8a9f3b0345dfe))
* request for ACL for ACO [[#576](https://github.com/vrozaev/ytsaurus-ui/issues/576)] ([0f46beb](https://github.com/vrozaev/ytsaurus-ui/commit/0f46beb68fa523ada3200123769ac95927d0b3ff))
* **Scheduling/ACL:** error when switch to another pool from ACL tab [YTFRONT-4487] ([06809d8](https://github.com/vrozaev/ytsaurus-ui/commit/06809d8cb03ea36b6214670c190d526bed2c0ebd))
* **Scheduling/ACL:** reload acl when pool tree changed [YTFRONT-4172] ([b697bf3](https://github.com/vrozaev/ytsaurus-ui/commit/b697bf3e40fdc97a07d3d009201ec6e5bdafef17))
* **Scheduling:** ignore missing ehemeral pools [YTFRONT-4191] ([10fea47](https://github.com/vrozaev/ytsaurus-ui/commit/10fea47e32016712de42a4a7e127e056fcf15c07))
* **Settigns:** export DiscribedSettings type [YTFRONT-4499] ([5ab93eb](https://github.com/vrozaev/ytsaurus-ui/commit/5ab93ebc59c15f9257c39804effa7134181c3c9a))
* **Sort,Merge:** get rid of missing node errors [YTFRONT-4392] ([cf79a79](https://github.com/vrozaev/ytsaurus-ui/commit/cf79a79ac5366bd5e547eb18ebb2284cc5ae6234))
* **StructuedYsonVirtualized:** fix scroll for parsed string value [[#765](https://github.com/vrozaev/ytsaurus-ui/issues/765)] ([c696380](https://github.com/vrozaev/ytsaurus-ui/commit/c69638021e559dd6be4bfa1234982358574ebfae))
* **System/Master:** bring back 'Queue agents' [YTFRONT-4145] ([1a82e8e](https://github.com/vrozaev/ytsaurus-ui/commit/1a82e8e88e9ce3069c279a4b931866a30734629a))
* **System/Masters:** minor fix for layout with alerts [YTFRONT-4295] ([2134144](https://github.com/vrozaev/ytsaurus-ui/commit/2134144fb7829d6eb2010d65103376019a932036))
* **System/Nodes:** minor fixes [YTFRONT-3297] ([3d78cfe](https://github.com/vrozaev/ytsaurus-ui/commit/3d78cfe2b99cec3c779eead885d6e8cd5440f413))
* **System:** fix color of stats text in dark mode ([f1c3ec3](https://github.com/vrozaev/ytsaurus-ui/commit/f1c3ec3fc73a5bac17c0bffa2c3229a47c710ec3))
* **System:** fixed typo, now we check correct "maintenance" attribute ([c97f9be](https://github.com/vrozaev/ytsaurus-ui/commit/c97f9be7cb8db3a8dc1efaeb82252755ad4d5367))
* **System:** nonvoting position [YTFRONT-4209] ([901da6f](https://github.com/vrozaev/ytsaurus-ui/commit/901da6f484b16cdd4b8c79beb2e53d422be6b48c))
* **System:** now we are trying make a request to another primary masters if first one did not responded correctrly [[#529](https://github.com/vrozaev/ytsaurus-ui/issues/529)] ([fc25ad4](https://github.com/vrozaev/ytsaurus-ui/commit/fc25ad493adb410ae66876ca7746dd3665f6a04a))
* **System:** timestamp providers maintenance [YTFRONT-4452] ([fa837cd](https://github.com/vrozaev/ytsaurus-ui/commit/fa837cd575aea8d30f6c6a434bbeffa65c16868c))
* **System:** use correct colors for StatsInfo in light and dark theme ([4897f6f](https://github.com/vrozaev/ytsaurus-ui/commit/4897f6f4fa1b414e944bf392b08d9dd945514dd8))
* **Table/Schemd:** minor css fix [YTFRONT-4166] ([6b9cca4](https://github.com/vrozaev/ytsaurus-ui/commit/6b9cca40f314fd544f3f90a280b1db72f48404db))
* **TabletCellBundle/Instances:** notice for in-progress allocation [YTFRONT-4167] ([2218d61](https://github.com/vrozaev/ytsaurus-ui/commit/2218d617dffc89a33cdab5ef4a1de908300a2545))
* **Tablet:** fix for node url [YTFRONT-4269] ([82de290](https://github.com/vrozaev/ytsaurus-ui/commit/82de2908b58d2f18f583c6869db6de601064725c))
* **TimelinePicker:** minor fix [YTFRONT-4180] ([20326c0](https://github.com/vrozaev/ytsaurus-ui/commit/20326c0bb47889a0d0ffe8fd55b25b6b11681ab1))
* **Toaster:** line break in toaster content [YTFRONT-4543] ([eb8faba](https://github.com/vrozaev/ytsaurus-ui/commit/eb8fabaa788f6e78c6921c7bbd4a19280d6f3cc5))
* **UI:** celebration theme fix ([67db4f4](https://github.com/vrozaev/ytsaurus-ui/commit/67db4f41aaa7e84449a88cdeff96f78361b0c88b))
* **YQLTable:** fix appearance of truncated value in cell ([f5daaca](https://github.com/vrozaev/ytsaurus-ui/commit/f5daaca691c0e94e7cfac2b712a2d392d66cfb5e))
* **YQLTable:** fixed exception in truncated cells preview ([a351378](https://github.com/vrozaev/ytsaurus-ui/commit/a35137899782ab251f9515db8d87ad92f05c23b1))


### Reverts

* "chore: now primary masters do not request data from endpoinds which a…" ([99b6884](https://github.com/vrozaev/ytsaurus-ui/commit/99b6884317cb9947f5d47c5c20a54f453d5ce563))
...
* The following workspace dependencies were updated
  * dependencies
    * @ytsaurus/javascript-wrapper bumped from ^0.10.3 to ^0.11.0
  * devDependencies
    * @ytsaurus/interface-helpers bumped from ^0.3.0 to ^0.3.2
